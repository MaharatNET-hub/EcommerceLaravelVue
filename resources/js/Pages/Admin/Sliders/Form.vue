...
<template>
    ...
    <form @submit.prevent="submit" class="max-w-xl space-y-4 rounded-xl bg-white p-6 shadow-sm">
        ...
        <div>
            <label class="mb-1 block text-sm font-medium text-gray-700">العنوان الفرعي</label>
            <input v-model="form.subtitle" type="text" class="w-full rounded-lg border-gray-300" />
        </div>
        <div>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label class="mb-1 block text-sm font-medium text-gray-700">نص الزر</label>
                <input v-model="form.button_text" type="text" class="w-full rounded-lg border-gray-300" />
            </div>
            <div>
